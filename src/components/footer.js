      ...
      <Container>
        <Row>
          ...
          <Column>
            ...
            <FooterLink href="/news/science" className="newsSection">SCIENCE</FooterLink>
          ...
          <Column>
            ...
            <FooterLink href="#">
              <i className="fab fa-facebook-f">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="1em" height="1em" data-component="Facebook" class="_2iH5w _23HBT" aria-hidden="true"><path fill="currentColor" d="M9.668 21h3.335v-8.996h2.502L16 9.194h-2.997V7.157c0-.759.309-1.346 1.26-1.346h1.494V3h-2.088c-3.24.013-4 1.99-3.995 3.937l-.006 2.257H8v2.81h1.668V21z"></path></svg>
